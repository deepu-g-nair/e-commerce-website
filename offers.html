...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <img src="images/undraw.png" style="width:100%;margin-top:50px;">
        </div>
        <div class="col-md-6">
            <form method="post">
                <div style="border:4px solid whitesmoke;padding:30px;">
                    ...
                    <input type="text" name="seller_name" placeholder="Full Name" class="form-control" style="margin-bottom: 20px;" required>
                    <input type="text" name="seller_age" placeholder="Age" minlength="1" maxlength="2" class="form-control" style="margin-bottom: 20px;" required>
                    <select name="seller_gender" class="form-control" required style="margin-bottom: 20px;">
                    ...
                    <textarea name="seller_address" placeholder=" Address" rows="4" cols="80" class="form-control" style="margin-bottom: 20px;" required></textarea>
                    <input type="text" name="seller_number" placeholder="Phone Number" minlength="10" maxlength="10" class="form-control" style="margin-bottom: 20px;" required>
                    <input type="text" name="seller_landmark" placeholder="Nearest Landmark" class="form-control" style="margin-bottom: 20px;" required>
                    <input type="text" name="seller_pincode" placeholder="Pincode" minlength="6" maxlength="6" class="form-control" style="margin-bottom: 20px;" required>
                    <input type="submit" name="button_seller" value="Register Now" class="btn btn-success" style="width:130px;background:#25b81e;" required>
...
<?php
if( isset($_GET['lo_sx_mo']) && !empty( $_GET['lo_sx_mo'] ))
{
    ?> <script>
        
          swal({

                text: " Registration completed successfully . We will contact you soon  ",
                icon: "success",
                successMode: true,
...
if( isset($_GET['li_sx_mi']) && !empty( $_GET['li_sx_mi'] ))
{
  $sai=urldecode($_GET['li_sx_mi']);
  $sai= encryptor('decrypt', $sai);
  $stai=urlencode($sai);
  $stai= encryptor('encrypt', $stai);
    ?> <script>
        var cc='<?php echo $stai; ?>';
          swal({
          ...
          .then((willDelete) =>
          {
              if (willDelete)
              {
                    location.replace("index.php?q="+cc);
